...
//        }, 1000 );
    ...
    */                
    ...
    $.martanianHideSlide = function( slideID ) {
        ...
        currentSlide.children( '.flying-1' ).addClass( 'animated bounceOutRight' );
        currentSlide.children( '.flying-2' ).addClass( 'animated bounceOutLeft' );
        
        setTimeout( function() {
        
            currentSlide.children( '.flying-1' ).removeClass( 'animated bounceOutRight' ).hide();
            currentSlide.children( '.flying-2' ).removeClass( 'animated bounceOutLeft' ).hide();
